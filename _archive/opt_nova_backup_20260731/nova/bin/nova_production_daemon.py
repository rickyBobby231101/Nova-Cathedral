...
class NovaProductionDaemon:
    ...
    def setup_logging(self):
        ...
        log_level = self.config.get("nova", "log_level") if self.config.has_option("nova", "log_level") else "INFO"
    ...
    def init_voice_system(self):
        ...
        try:
            voice_enabled = self.config.getboolean('nova', 'voice_enabled') if self.config.has_option('nova', 'voice_enabled') and self.config.getboolean('nova', 'voice_enabled') else True
            voice_provider = self.config.get("nova", "voice_provider") if self.config.has_option("nova", "voice_provider") else "openai"
    ...
    def init_bridge_system(self):
        ...
        try:
            bridge_enabled = self.config.getboolean('nova', 'bridge_enabled') if self.config.has_option('nova', 'bridge_enabled') and self.config.getboolean('nova', 'bridge_enabled') else True
    ...
    def get_memory_count(self):
        ...
        return int(self.config.get('nova', 'memory_threshold') if self.config.has_option('nova', 'memory_threshold') else '1447')
    ...
    def start_socket_server(self):
        ...
        try:
            ...
            server.listen(int(self.config.get('nova', 'max_connections') if self.config.has_option('nova', 'max_connections') else '10'))
    ...
    def handle_socket_client(self, client):
        ...
        try:
            timeout = int(self.config.get('nova', 'socket_timeout') if self.config.has_option('nova', 'socket_timeout') else '30')
    ...
    def heartbeat_loop(self):
        ...
        interval = int(self.config.get('nova', 'heartbeat_interval') if self.config.has_option('nova', 'heartbeat_interval') else '60')
